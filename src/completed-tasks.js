const completeTasksPage = document.querySelector(".js-manipulated-container");
const completeTasksBtn = document.querySelector(".completed-tasks-btn");
...
function initializeCompletedTasksPage(){
    let completeTasksHTML = `
        <div class="completed-tasks-main-container">
            <header>
    ...
    completeTasksPage.innerHTML = completeTasksHTML
}