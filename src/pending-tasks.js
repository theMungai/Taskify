const pendingTasksPage = document.querySelector(".js-manipulated-container");
...
function initializePendingTasksPage(){
    let pendingTasksHTML = `
        <div class="pending-tasks-main-container">
            <header>
                <h1>Pending Tasks</h1>
            </header>
    ...
    pendingTasksPage.innerHTML = pendingTasksHTML;
}